...
function getDatosRoom() {
  $.ajax({
    url: "http://129.151.124.210:8080/api/Room/all",
...
function guardarRoom() {
  let myData = {
    ...
    url:"http://129.151.124.210:8080/api/Room/save",
...
function editarRoom() {
  ...
  $.ajax({
    url: "http://129.151.124.210/api/Room/update",
    type: "PUT",
    data: dataToSend,
...
function borrarRoom(idElemento) {
  ...
  let dataToSend = JSON.stringify(myData);
  $.ajax({
    url: "http://129.151.124.210/api/Room/"+idElemento,
    type: "DELETE",
    data: dataToSend,
    contentType: "application/JSON",
    datatype: "JSON",
...
function obtenerItemEspecificoroom(items) {
  ...
  $.ajax({
    dataType: "json",
    url: "http://129.151.124.210/api/Room/" + items,
    type: "GET",
    success: function (response) {
