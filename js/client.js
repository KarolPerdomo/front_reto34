...
function getDatosClient() {
    $.ajax({
        url: "http://129.151.124.210:8080/api/Client/all",
...
function guardarClient() {
    ...
    $.ajax({
        ...
        url:"http://129.151.124.210:8080/api/Client/save",
...
function editarClient() {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://129.151.124.210:8080/api/Client/update",
        type: "PUT",
        data: dataToSend,
...
function borrarClient(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://129.151.124.210:8080/api/Client/"+idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
...
function obtenerItemEspecificoClient(items) {
    ...
    $.ajax({
        dataType: "json",
        url: "http:/129.151.124.210:8080/api/Client/" + items,
        type: "GET",
        success: function (response) {
