function getDatosCategoria(){
    $.ajax({
        url:"http://129.151.124.210:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarCategoria(){
    let var2 = {
        ...
        url:"http://129.151.124.210:8080/api/Category/save",
...
function editarCategoria() {
    ...
    $.ajax({
        url: "http://129.151.124.210:8080/api/Category/update",
        type: "PUT",
        data: dataToSend,
...
function borrarCategoria(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://129.151.124.210:8080/api/Category/"+idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
...
function obtenerItemEspecificoCategoria(items) {
    ...
    $.ajax({
        dataType: "json",
        url: "http://129.151.124.210:8080/api/Category/" + items,
        type: "GET",
        success: function (response) {
