...
function getDatosReservation() {
    $.ajax({
        url: "http://129.151.124.210:8080/api/Reservation/all",
...
function guardarReservation() {
    ...
    $.ajax({
        ...
        url:"http://129.151.124.210:8080/api/Reservation/save",
...
function editarReservation() {
    ...
    $.ajax({
        url: "http://129.151.124.210:8080/api/Reservation/update",
        type: "PUT",
        data: dataToSend,
...
function borrarReservation(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://129.151.124.210:8080/api/Reservation/"+idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
...
function obtenerItemEspecificoReservation(items) {
    ...
    $.ajax({
        dataType: "json",
        url: "http://129.151.124.210:8080/api/Reservation/" + items,
        type: "GET",
        success: function (response) {
